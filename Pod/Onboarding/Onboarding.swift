...
struct Onboarding: View {
  ...
  var screens: [OnboardingScreenModel] = [
    OnboardingScreenModel(
      title: "Welcome to Pod", iconName: "appIcon",
      description: "Click the middle button to proceed"),
    OnboardingScreenModel(
      title: "Guide", iconName: "hand.draw.fill", heading: "Click Hold Drag",
      description: "Click wheel is used by dragging in a circle"),
    OnboardingScreenModel(
  ...
  var body: some View {
    ZStack {
      if screens[viewModel.activeScreen].isRadioSetup {
        ...
        OnboardingScreen(
          screen: screens[viewModel.activeScreen], activeScreen: viewModel.activeScreen,
          viewModel: viewModel)
      }
    }.padding()
  }
